    ...
    <section id="about" className="py-section-gap px-margin-mobile md:px-margin-desktop bg-surface-alt max-w-full">
      <div className="max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        >
          ...
          <h2 className="font-headline-lg text-on-surface mb-6">About Us: Your Gateway to the Coast</h2>
        ...
        >
          <h3 className="font-headline-md text-on-surface border-b border-on-surface/10 pb-4">Why Travel With Us?</h3>
          <div>
