    ...
    <section id="about" className="py-section-gap px-margin-mobile md:px-margin-desktop bg-surface-alt max-w-full">
      <div className="max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        >
          ...
          <h2 className="font-headline-lg text-on-surface mb-6"><span className="text-8xl text-on-surface">About Us:</span> <span className="text-8xl text-primary">Your Gateway</span><span className="font-bold"> to the Coast</span></h2>
