        ...
        <div className="columns-2 md:columns-3 lg:columns-4 gap-3 md:gap-4">
          {galleryImages.map((image, i) => (
            <motion.div
              ...
              className={`break-inside-avoid mb-3 md:mb-4 overflow-hidden rounded-xl group relative ${image.fleet ? "bg-surface-container" : ""
                }`}
            >
              ...
              <Image
                ...
                width={800}
                height={600}
                className={`w-full h-auto transition-transform duration-700 group-hover:scale-105 block ${image.fleet ? "object-contain p-4" : "object-cover"
                  }`}
              />
            </motion.div>
          ))}
